...
const candidateData = [
  { id: 8, name: 'Emma Johnson', description: 'Financial expert.', motto: 'Money matters', party: 'Finance Party', image: '👩‍💼', color: 'from-red-500 via-red-600 to-red-700' },
  { id: 9, name: 'Chris Evans', description: 'Meticulous and fair.', motto: 'Count on me', party: 'Balance Party', image: '👨‍💼', color: 'from-indigo-500 via-indigo-600 to-indigo-700' }
]
